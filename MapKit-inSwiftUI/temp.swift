...
//    @State private var region = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 40.71, longitude: -82), span: MKCoordinateSpan(latitudeDelta: 0.9, longitudeDelta: 0.9))
//    @State private var locations = [MKPointAnnotation]()
//    @State private var pin: [Pin] = []
//    @State private var centerCoordinate = CLLocationCoordinate2D()
//    @State private var removeLine: Bool = false
...
//    var body: some View {
//        ZStack {
//            MapView(centerCoordinate: $centerCoordinate, removeLine: $removeLine, currentSelectedMapType: $currentSelectedMapType, adivsoryNotices: $advisoryNotices, annotations: $locations)
...
//                    if removeLine == true {
//                        print("IS EMPTY")
//                        view.removeOverlay(route.polyline)
//                    }
//                    
//                    
